            ...
            parallel {
                stage('DEB') {
                    ...
                    steps {
                        ...
                        sh 'make RESTY_IMAGE_BASE=ubuntu RESTY_IMAGE_TAG=20.04 DOCKER_MACHINE_ARM64_NAME="kong-"`cat /proc/sys/kernel/random/uuid` AWS_ACCESS_KEY=instanceprofile RELEASE_DOCKER=true release'
                    }
                }
            }
        }
